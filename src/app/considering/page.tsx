...
const ConsideringContent = () => {
  ...
  // 検討銘柄を取得
  const consideringStocks = getConsideringStocks();
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-gray-100 border border-gray-300 text-gray-700 px-6 py-8 rounded-lg text-center">
          ...
          <p className="mb-4">銘柄名の横にあるステータスボタンを押して、検討銘柄を追加してください。</p>
          <button
            onClick={() => router.push('/')}
    ...
    <div className="container mx-auto px-4 py-8">
            ...
            <p>
              {isSearchActive ? (
                <>
                  ...
                  <span className="ml-2 text-blue-600">（全{consideringCount}銘柄中）</span>
                </>
              ) : (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {displayStocks.map((stock) => (
          <StockCard key={stock.code} stock={stock} linkPrefix="considering" />
        ))}
      </div>
